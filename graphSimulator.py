...
def calculate_theoretical_reliability():
    ...
    computed_reliability = theoreticalReliabitlity.successProbability(t0(S,alpha, C, v_d, R_min, R_c), t0(S,alpha, C, v_d, R_min, R_c),L, R ,m_f )  # Set your constant value here
